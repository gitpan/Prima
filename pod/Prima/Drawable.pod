=for rcs $Id: Drawable.pod,v 1.11 2002/09/25 13:31:21 dk Exp $
...
text, and also provides the tilda ( ~ )- character underlining support.
...
and LIGHT_COLOR and DARK_COLOR colors. If BACK_COLOR is specifed, paints
