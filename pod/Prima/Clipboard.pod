=for rcs $Id: Clipboard.pod,v 1.3 2002/09/25 13:31:21 dk Exp $

=head1 NAME

Prima::Clipboard - GUI-driven intreprocess communication
...
This field is used to distingush between data formats.
...
Different system provide spectrum of pre-defined data
...
register its own formats. Both pre-defined and newly defined data 
formats are described by a string, and the two pre-defined formats
...
Only the pre-defined formats, and the formats registered
...
Returns array of strings, each repersenting
