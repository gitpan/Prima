=for rcs $Id: Printer.pod,v 1.3 2002/05/14 13:22:32 dk Exp $

=head1 NAME

Printer - system printing services
...
The capabilites of the selected printer can be adjusted via C<setup_dialog()>
...
Stops the printing session, returns the object to the disabled paiinting state.
...
Does not report eventual errors, occured during the spooling process -
...
In this setup, the user can adjust the capablities of the printer,
