...
%Config_inst = (
	incpaths              => [ '/usr/local/lib/perl5/site_perl/5.8.8/mach/Prima/CORE','/usr/local/lib/perl5/site_perl/5.8.8/mach/Prima/CORE/generic','/usr/local/lib/perl5/5.8.8/mach/CORE','/usr/local/include','/usr/X11R6/include','/usr/X11R6/include/freetype2' ],
	...
	inc                   => '-I/usr/local/lib/perl5/site_perl/5.8.8/mach/Prima/CORE -I/usr/local/lib/perl5/site_perl/5.8.8/mach/Prima/CORE/generic -I/usr/local/lib/perl5/5.8.8/mach/CORE -I/usr/local/include -I/usr/X11R6/include -I/usr/X11R6/include/freetype2',
);
...
%Config = (
	...
	platform              => 'unix',
	compiler              => 'gcc',
	incpaths              => [ '/usr/home/dk/src/Prima/include','/usr/home/dk/src/Prima/include/generic','/usr/local/lib/perl5/5.8.8/mach/CORE','/usr/local/include','/usr/X11R6/include','/usr/X11R6/include/freetype2' ],
	platform_path         => '/usr/home/dk/src/Prima/unix',
	gencls                => '\'/usr/local/bin/perl5.8.8\' /usr/home/dk/src/Prima/utils/gencls.pl',
	tmlink                => '\'/usr/local/bin/perl5.8.8\' /usr/home/dk/src/Prima/utils/tmlink.pl',
	scriptext             => '',
